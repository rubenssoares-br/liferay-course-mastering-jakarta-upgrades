...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Clarity Insurance Benefits Tracker REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Clarity Insurance Benefits Tracker REST", version = "v1.0")
)
@Path("/v1.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(BenefitUsageResourceImpl.class);

			add(InsurancePlanResourceImpl.class);

			add(PlanEnrollmentResourceImpl.class);
