package com.clarityvisionsolutions.insurance.benefits.tracker.web.plans.admin.portlet.toolbar.contributor;
...
@Component(
	...
	property = {
		...
		"mvc.render.command.name=/insurance-plans/view"
	},
	service = PortletToolbarContributor.class
)
public class InsurancePlanAdminPortletToolbarContributor
	...
	protected List<MenuItem> getPortletTitleMenuItems(
		...
		urlMenuItem.setLabel(
			_language.get(themeDisplay.getLocale(), "add-insurance-plan"));
